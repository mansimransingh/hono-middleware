...
type ImportKind = 'entry-point' | 'import-statement' | 'require-call' | 'dynamic-import' | 'require-resolve' | 'import-rule' | 'composes-from' | 'url-token';
...
export { type AnalyzeMetafileOptions, type BuildContext, type BuildFailure, type BuildOptions, type BuildResult, type Charset, type Drop, type Format, type FormatMessagesOptions, type ImportKind, type InitializeOptions, type Loader, type Location, type LogLevel, type Message, type Metafile, type Note, type OnEndResult, type OnLoadArgs, type OnLoadOptions, type OnLoadResult, type OnResolveArgs, type OnResolveOptions, type OnResolveResult, type OnStartResult, type OutputFile, type PartialMessage, type PartialNote, type Platform, type Plugin, type PluginBuild, type ResolveOptions, type ResolveResult, type ServeOnRequestArgs, type ServeOptions, type ServeResult, type StdinOptions, type TransformFailure, type TransformOptions, type TransformResult, type TsconfigRaw, type WatchOptions, analyzeMetafile, analyzeMetafileSync, build, buildSync, context, formatMessages, formatMessagesSync, initialize, transform, transformSync, version };
