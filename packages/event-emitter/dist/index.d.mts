...
interface Emitter<EPMap extends EventPayloadMap> {
    ...
    emitAsync<Key extends keyof EPMap>(c: Context, key: Key, payload: EPMap[Key], options?: EmitAsyncOptions): Promise<void>;
}
/**
 ...
 *
 */
declare const createEmitter: <EPMap extends EventPayloadMap>(eventHandlers?: EventHandlers<EPMap> | undefined, options?: EventEmitterOptions) => Emitter<EPMap>;
/**
 * Event Emitter Middleware for Hono.
 *
 ...
 * ```
 */
declare const emitter: <EPMap extends EventPayloadMap>(eventHandlers?: EventHandlers<EPMap> | undefined, options?: EventEmitterOptions) => MiddlewareHandler;
